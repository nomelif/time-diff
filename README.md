...
Command entered:
    ...
    $ grep Logitech /var/log/messages | ./time_diff/bin/time-diff
...
* **-f**: If set forces TimeDiff to treat all numerical values without zero-padding, basically the opposite of **-p**. Eg. Tue Oct 05 would become Tue Oct 5.
